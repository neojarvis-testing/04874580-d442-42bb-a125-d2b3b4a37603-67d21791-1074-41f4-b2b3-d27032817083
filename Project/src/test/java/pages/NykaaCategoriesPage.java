...
public class NykaaCategoriesPage {
    ...
    public void verifyCategories() {
        try {
            ...
            Assert.assertTrue(categories.contains(ExcelReader.readdata(System.getProperty(userDirectory) + testdataFolder, sheetOfCategories, 0, 1)));
    ...
    public void verifyKajal() {
        try {
            ...
            Assert.assertTrue(kajal.contains(ExcelReader.readdata(System.getProperty(userDirectory) + testdataFolder, sheetOfCategories, 1, 0)));
    ...
    public void verifyText() {
        try {
            ...
            Assert.assertTrue(text.contains(ExcelReader.readdata(System.getProperty(userDirectory) + testdataFolder, sheetOfCategories, 1, 1)));

...
public class NykaaCategoriesPageLocators {
    ...
    public static By searchBar = By.name("search-suggestions-nykaa");
    ...
    public static By fragrance = By.cssSelector("a[text() = 'fragrance']");
    public static By newLaunches = By.cssSelector("a[href = '/fragrance/new-launches/c/187?ptype=lst&id=187&root=nav_3&dir=desc&order=popularity']");
    public static By firstProduct = By.xpath("//div[text() = 'BVLGARI Omnia Crystalline Eau de Toilette For Her']");

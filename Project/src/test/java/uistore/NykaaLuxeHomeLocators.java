...
public class NykaaLuxeHomeLocators {
    public static By Luxe=By.cssSelector("#footer_id > div.css-1h4fvsk > div > div:nth-child(5) > ul > a");
    ...
    public static By UnisexText=By.cssSelector("div[class='css-3i7s5s']");
